...
As an alternate way to get your editor to understand the repo's first-party sources, you need to tell it about the repo's [source roots](./key-concepts/source-roots.mdx). You can list those with:
